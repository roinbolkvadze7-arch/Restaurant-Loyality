...
### 📱 **QR სკანერით (რეკომენდებული):**
1. მიმტანი ხსნის **scanner.html** გვერდს მობილურზე
2. "📷 სკანერის ჩართვა" → QR კოდის სკანირება
3. ავტომატურად გამოჩნდება სტუმრის ინფო
4. შეიყვანოს შეკვეთის ღირებულება → "✅ ქულების დამუშავება"
5. ავტომატურად ითვლება ქულები, აქციები, დონის ბონუსები

### 🖥️ **ადმინ პანელით (ალტერნატიული):**
1. სტუმარი ატყობინებს ტელეფონის ნომერს
2. მიმტანი ხსნის **admin.html** → სტუმრები → კორექტირება
3. ხელით ამატებს ქულებს
4. სტუმარი ხედავს ახლებულ ბალანსს **index.html**-ში

---

## 🎯 ახალი ფუნქციები (დამატებული)

### ✅ სპეციალური აქციების სისტემა
- აქციების შექმნა და მართვა ადმინ პანელიდან
- სხვადასხვა ტიპის ფასდაკლებები (%, ქულების ×, ბონუს ქულები)
- დონეების და კვირის დღეების მიხედვით ტარგეტირება
- რეალ-თაიმ აქციების ჩვენება სტუმრის აპში

### ✅ რეფერალური პროგრამა  
- მომწვევი იღებს 1000 ქულას, მოწვეული — 500
- ავტომატური რეფერალური ლინკები
- რეფერალური სტატისტიკა ადმინ პანელში
- URL პარამეტრებით მუშაობა

### ✅ დაბადების დღის ავტომატიზაცია
- ავტომატური 500 ქულის ბონუსი დაბადების დღეს
- ადმინ პანელიდან მანუალური ტრიგერი
- ერთხელ წელიწადში შეზღუდვა
